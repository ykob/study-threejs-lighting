...
export default class WebGLContent {
  constructor() {
    ...
    this.dirLight1 = new DirectionalLight(0xff0000, 0.1)
    this.dirLight1.position.set(-20, 20, 20)
    this.dirLight2 = new DirectionalLight(0x0000ff, 0.1)
    this.dirLight2.position.set(20, 20, 20)
    this.pointLight1 = new PointLight(0xff3333, 0.4, 160)
    this.pointLight1.position.set(-50, 20, 0)
    this.pointLight2 = new PointLight(0x3333ff, 0.4, 160)
